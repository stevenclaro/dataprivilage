    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="图纸" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'tz', validatorRules.tz]" placeholder="请输入图纸"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'tz','tzname'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'tz','tzname'))
      }
